...
public class ClientInMemory  implements IRoadStatusClient{
	...
	public static void main(String[] args) {
		...
		try {
			...
			client.methodGetPicture(3);

			Picture picture = new Picture(1, "eeee", "eeee", new Point(30.0, 20.1));
			...
			client.methodGetPicture(3);
			client.methodPutPicture(picture);
			client.methodPutPicture(picture);
			client.methodPutPicture(picture);
	...
	public Picture methodGetPicture(long id) throws JsonParseException, JsonMappingException, IOException {
		for (Picture picture : store) {
			if (picture.getId() == id) {
				System.out.println("GET: OK; " + picture);
				return picture;
			}
		}
	...
	public void methodPostPicture(Picture picture) {
		...
		picture.setId(idTmp);
		store.add(picture);
		System.out.println("POST: OK; " + picture);
	}
	...
	public void methodPutPicture(Picture picture) {
		...
		picture.setId(idTmp);
		store.add(picture);
		System.out.println("PUT: CREATE; new id = " + idTmp + ";" + picture);
	}
